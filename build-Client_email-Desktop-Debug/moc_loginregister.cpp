...
void LoginRegister::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LoginRegister *_t = static_cast<LoginRegister *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (LoginRegister::*_t)(QStringList );
...
const QMetaObject LoginRegister::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_LoginRegister.data,
