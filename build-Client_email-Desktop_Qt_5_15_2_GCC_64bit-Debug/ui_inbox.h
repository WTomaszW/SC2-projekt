...
public:
    ...
    void setupUi(QMainWindow *Inbox)
    {
        ...
        label->setGeometry(QRect(0, 0, 131, 17));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(10, 20, 461, 17));
        Inbox->setCentralWidget(centralwidget);
        toolBar = new QToolBar(Inbox);
        toolBar->setObjectName(QString::fromUtf8("toolBar"));
        Inbox->addToolBar(Qt::LeftToolBarArea, toolBar);
    ...
    void retranslateUi(QMainWindow *Inbox)
    {
        ...
        label->setText(QCoreApplication::translate("Inbox", "Wiadomo\305\233ci:", nullptr));
        label_2->setText(QString());
        toolBar->setWindowTitle(QCoreApplication::translate("Inbox", "toolBar", nullptr));
    } // retranslateUi
